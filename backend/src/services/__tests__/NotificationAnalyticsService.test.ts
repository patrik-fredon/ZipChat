...
describe('NotificationAnalyticsService', () => {
	...
	describe('trackNotificationDelivery', () => {
		it('should create a new notification analytics record', async () => {
			const result = await service.trackNotificationDelivery(mockNotificationAnalytics.notificationId, mockNotificationAnalytics.userId, mockNotificationAnalytics.deviceInfo, mockNotificationAnalytics.performanceMetrics);
	...
	describe('updateDeliveryStatus', () => {
		it('should update delivery status', async () => {
			const analytics = await service.trackNotificationDelivery(mockNotificationAnalytics.notificationId, mockNotificationAnalytics.userId, mockNotificationAnalytics.deviceInfo, mockNotificationAnalytics.performanceMetrics);

			const updated = await service.updateDeliveryStatus(analytics.notificationId, 'delivered');
	...
	describe('trackEngagement', () => {
		it('should track user engagement', async () => {
			...
			const updated = await service.trackEngagement(analytics.notificationId, 'opened');
	...
	describe('getNotificationAnalytics', () => {
		it('should return analytics for a user within date range', async () => {
			...
			await service.trackNotificationDelivery(mockNotificationAnalytics.notificationId, mockNotificationAnalytics.userId, mockNotificationAnalytics.deviceInfo, mockNotificationAnalytics.performanceMetrics);

			const analytics = await service.getNotificationAnalytics(mockNotificationAnalytics.userId, startDate, endDate);
